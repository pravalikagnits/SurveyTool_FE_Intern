                    ...
                    render() {
                      return (
                        ...
                        <h1>Survey details</h1>
                               ...
                               Name:<input type="text" id="name" value = {this.state.sname} onChange = {this.updatename} className="w3-input" ref="name" placeholder="surveyname"  /><br/><br/>
                               Description:<input type="text" value ={this.state.sdescription} onChange = {this.updatedescription} mode="multiline" ref="description" className="w3-input" placeholder="description"/><br/><br/>
                               Date:<input type="text" value ={this.state.date} onChange = {this.updatedate} className="w3-input" ref="date" placeholder="dd-mm-yyyy"/><br/><br/>
